...
rem ..\..\compiler\bin\sing -p -o ../inc/values.h  -u values.sing
rem ..\..\compiler\bin\sing -p -o ../inc/thread.h  -u thread.sing
rem ..\..\compiler\bin\sing -p -o ../inc/net.h  -u net.sing -I .
pause